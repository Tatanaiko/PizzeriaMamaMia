    ...
    return (
        <nav className="flex gap-2 md:text-xl items-center md:justify-between w-full p-2 text-xs bg-gray-950 text-white justify-center ">
            ...
            <ul className="flex gap-2 pe-5 md:text-base">
                <li><button className="border rounded px-3 py-1 cursor-pointer">Home</button></li>
                {token ? (
                <>
                    <li><button className="border rounded px-3 py-1 cursor-pointer">Profile</button></li>
                    <li><button className="border rounded px-3 py-1 cursor-pointer">Logout</button></li>
                </>
                ) : (
                    <>
                    <li><button className="border rounded px-3 py-1 cursor-pointer">Login</button></li>
                    <li><button className="border rounded px-3 py-1 cursor-pointer">Register</button></li>
                    </>
                )}
